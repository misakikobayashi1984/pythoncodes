...
class VOCClassSegBase(chainer.dataset.DatasetMixin):
    ...
    def __init__(self, year, split='train', dataset_dir = '', transform=True):
        self.split = split
...
class VOC2011ClassSeg(VOCClassSegBase):
    ...
    def __init__(self, split='train', dataset_dir = '', transform=True):
        super(VOC2011ClassSeg, self).__init__(
            year=2011, split=split, dataset_dir = dataset_dir, transform=transform)
